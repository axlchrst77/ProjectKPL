...
<div class="modal fade" id="tambah_disposisi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?php echo base_url('home/tambah_ketdisposisi') ?>" method="post"
...
<div class="modal fade" id="ubah_disposisi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?php echo base_url('home/ubah_ketdisposisi') ?>" method="post"
                  enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<script>
    function ubah_disposisi(id) {
        ...
        $.getJSON('<?php echo base_url('home/get_ketdisposisi_by_id/')?>' + id, function (data) {
