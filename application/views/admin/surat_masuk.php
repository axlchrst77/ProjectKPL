                    ...
                    if (isset($data_surat_masuk)) {
                        foreach ($data_surat_masuk as $surat_masuk) {
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align: middle;">' . date('d-m-Y',strtotime($surat_masuk->tgl_kirim)) . '</td>
                                <td class="text-center" style="vertical-align: middle;">' . date('d-m-Y',strtotime($surat_masuk->tgl_terima)) . '</td>
                                <td class="text-center" style="vertical-align: middle;">' . $surat_masuk->pengirim . '</td>
								<td class="text-center" style="vertical-align: middle;">' . $surat_masuk->penerima . '</td>
...
<div class="modal fade" id="tambah_surat_masuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?php return base_url('home/tambah_surat_masuk') ?>" method="post"
...
<div class="modal fade" id="ubah_surat_masuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?php return base_url('home/ubah_surat_masuk') ?>" method="post"
                  enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div class="modal fade" id="ubah_file_surat_masuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?php return base_url('home/ubah_file_surat_masuk') ?>" method="post"
                  enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<script>
    function ubah_surat(id_surat) {
        ...
        $.getJSON('<?php return base_url('home/get_surat_masuk_by_id/')?>' + id_surat, function (data) {
