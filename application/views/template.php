            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    if ($this->session->userdata('level') == '1') {
						...
						<li>
                            <a href="' . base_url('home/user') . '"><i class="fa fa-user fa-fw"></i> User</a>
                        </li>
						<li>
                            <a href="' . base_url('home/unit') . '"><i class="fa fa-users fa-fw"></i> Unit </a>
                        </li>
                        <li>
						...
						<li>
							<a href="' . base_url('home/memo_masuk') . '"><i class="fa fa-envelope fa-fw"></i> Memo Masuk</a>
                        </li>
						<li>
							<a href="' . base_url('home/memo_keluar') . '"><i class="fa fa-envelope fa-fw"></i> Memo Keluar</a>
                        </li>
                        ';
                    } else {
                        return '
                        ...
                        <li>
                            <a href="' . base_url('home/disposisi_keluar') . '"><i class="fa fa-mail-forward fa-fw"></i> Disposisi Surat Keluar</a>
                        </li>
                        <li>
                            <a href="' . base_url('home/disposisi_masuk') . '"><i class="fa fa-mail-reply fa-fw"></i> Disposisi Surat Masuk</a>
                        </li>
						<li>
                            <a href="' . base_url('home/disposisi_memo_keluar') . '"><i class="fa fa-mail-forward fa-fw"></i> Disposisi Memo Keluar</a>
                        </li>
                        <li>
                            <a href="' . base_url('home/disposisi_memo_masuk') . '"><i class="fa fa-mail-reply fa-fw"></i> Disposisi Memo Masuk</a>
                        </li>
                        ';
                    }
                    ?>
